...
const CONFIG = {
  ...
  WHATSAPP_TOKEN: process.env.WHATSAPP_TOKEN || "EAANLqM41gEgBQwLcExZBNy4wmq7qtmfbyXPrMhbqWDzvJGT188BQzBuWuHgjZA2uu3eSEkHcD58fQfztCrZAyCiZBAxvO3ERzyVSEzzzf3TZCkqN7wSK3AfHZBems838Wto2o45tzRVfbvdnvR1nxZBGQ7UB1GQtZAjHsOpwhx1zOOxydIZBYYpEKQv7jnE5ScEkLGwZDZD",
...
app.get("/registrar", async (_, res) => {
  try {
    const r = await axios.post(
      `https://graph.facebook.com/v18.0/930517563487238/register`,
      { messaging_product: "whatsapp", pin: "000000" },
      { headers: { Authorization: `Bearer ${CONFIG.WHATSAPP_TOKEN}`, "Content-Type": "application/json" } }
    );
    res.json({ ok: true, mensaje: "✅ Número registrado correctamente", data: r.data });
  } catch (e) {
